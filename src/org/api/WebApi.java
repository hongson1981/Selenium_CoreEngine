...
public abstract class WebApi {
	...
	protected WebElement validateElement(String object_repository2) throws StopTest {
		...
		String type = object_repository2.split("=",2)[0];
		String what = object_repository2.split("=",2)[1];
	...
	protected WebElement validateElement() throws StopTest {
		...
		String type = object_repository.split("=",2)[0];
		String what = object_repository.split("=",2)[1];
		return driver.findElement(createElementLocator(type, what));
	}
	...
	protected String takeScreenShot() {
		String fileName = new SimpleDateFormat("yyyyMMddHHmmss_SSS'.png'").format(new Date());
